 ...
 *
 * farDT: findAndReplaceDOMText: https://github.com/padolsey/findAndReplaceDOMText
 */
...
foreach ($rphones as $rphone=>$phone) {
	...
	foreach ($patternList as $pattern) {
		...
		echo 'farDT(document.body, { find: "'.$regex.'", replace: mob ? "<a href=\"tel:'.$tphone.'\">'.$nphone.'</a>" : "'.$nphone.'", filterElements: fel });';
	}
}
?>
});
